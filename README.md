...
[![](https://img.shields.io/github/license/step-security/action-rubocop)](./LICENSE)
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/step-security/action-rubocop?logo=github&sort=semver)](https://github.com/step-security/action-rubocop/releases)
    ...
    steps:
      ...
      - uses: ruby/setup-ruby@v1
        with:
          ruby-version: '3.3'
          bundler-cache: true
      - uses: step-security/action-rubocop@v2
        with:
